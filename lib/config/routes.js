...
module.exports = function(app) {
  ...
  app.put('/api/events/:eventId/join', auth.ensureAuthenticated, events.join);
  app.put('/api/events/:eventId/unjoin', auth.ensureAuthenticated, events.unjoin);
  
  app.get('/api/profile/:userId/findMyEventsList', events.findMyEventsList);
  app.get('/api/profile/:userId/findEventsAttending', events.findEventsAttending);
